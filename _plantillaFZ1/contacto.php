    ...
    <section id="seccionContacto">
      <div class="container">
        <div class="row">
          <div class="col-xl-12">
            <div class="separador">
                <h2> Informacion de <span>contacto</span><i class="fas fa-comments float"></i></h2>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xl-6">
            <div id="infoContacto">
              ...
              <ul>
                <li><i class="fas fa-envelope"></i>&nbsp;MAIL: <a href="mailto:transporterodriguez@hotmail.com">transporterodriguez@hotmail.com</a></li>
                <li><i class="fas fa-phone"></i>&nbsp;TÉLEFONO: <a href="tel:3434260252">343-4260252</a>/<a href="tel:3434599524">343-4599524</a></li>
                <li><i class="fab fa-whatsapp"></i>&nbsp;WHATSAPP: <a href="https://wa.me/5493434599524">+5493434599524</a></li>
                <li><i class="fab fa-facebook"></i>&nbsp;FACEBOOK: <a href="#">facebook/transporte-rodruigez.com</a></li>
            ...
            <div id="contacto" class="container">
                ...
                <form action="https://formspree.io/factorzero@gmail.com" method="POST" class="contact_form clearfix">
                  <div class="campo clearfix" >
                    ...
                    <input type="text" id="nombre" class="form-control" name="nombre" placeholder="Su Nombre...">
                  </div>
                  <div class="campo clearfix">
                    <label for="mail">Mail:</label>
                    <input type="email" id="mail" class="form-control" name="mail" placeholder="Su mail...">
                  </div>
                  <div class="campo">
