    ...
    <input id="pageId" name="pageId" type="hidden" value="inicio">
    <div class="hero">
  ...
  <main>
    <!-- boton flotante -->
  <a class='flotante boton' href='contacto.php' ><i class="fas fa-comments"></i>&nbsp;Contacto</a>
<!-- <a class='flotante btn' href='contacto.php' ><i class="fas fa-phone-volume"></i></a> -->
  <!-- servicios -->
